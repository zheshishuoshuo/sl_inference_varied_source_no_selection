...
if __name__ == '__main__':
    ...
    mu_Mh = MODEL_PARAMS['deVauc']['mu_h0'] + MODEL_PARAMS['deVauc']['beta_h'] * (samples['logM_star'] - 11.4) + MODEL_PARAMS['deVauc']['xi_h'] * (samples['logRe'] - mu_Re.mean())
    pdf_Mh = norm.pdf(x_Mh, loc=mu_Mh.mean(), scale=MODEL_PARAMS['deVauc']['sigma_h'])
