...
if prec == 'low':
    A_interp = load_A_phys_interpolator(os.path.join(os.path.dirname(__file__), 'tables', 'A_phys_table_4D.csv'))
elif prec == 'high':
    A_interp = load_A_phys_interpolator(os.path.join(os.path.dirname(__file__), 'tables', 'A_phys_table_4D_high.csv'))
