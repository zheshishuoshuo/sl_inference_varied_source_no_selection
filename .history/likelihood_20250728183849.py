...
# === 全局缓存变量 ===
_data_df = None
_logMstar_interp_list = None
_detJ_interp_list = None
_use_interp = False


def set_context(data_df, logMstar_interp_list=None, detJ_interp_list=None, use_interp=False):
    global _data_df, _logMstar_interp_list, _detJ_interp_list, _use_interp
    _data_df = data_df
    _logMstar_interp_list = logMstar_interp_list
    _detJ_interp_list = detJ_interp_list
    _use_interp = use_interp
