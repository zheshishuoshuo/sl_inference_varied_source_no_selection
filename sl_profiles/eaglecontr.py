...
import os
import numpy as np
from sl_profiles import nfw, sersic
import sl_cosmology
from sl_cosmology import G, f_bar as baryon_fraction, Mpc, M_Sun, default_cosmo
...
def radius_NFW( M200, redshift=0.):  # R200 radius in kpc
    mean_density = 200. * sl_cosmology.rhoc(redshift, cosmo=default_cosmo)
...
grid_dir = os.environ.get('BHWLDIR') + '/sl_profiles/'
